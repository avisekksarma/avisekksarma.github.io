...
series_part: 2
reading_time: 18
description: "Indexes, query planning, transactions, window functions, N+1, connection pooling, and locks. The intermediate layer that separates engineers who write queries from engineers who own them."
---

In [Part 1](/blog/2026/database-skills-part-1-foundations/), we covered the foundation: the relational model, schema design, keys, constraints, joins, and aggregations. That's the bedrock.
...
*This post is part of the **Database Engineering: From Good to Great** series. [Part 1](/blog/2026/database-skills-part-1-foundations/) covers the relational model, schema design, and SQL fundamentals. [Part 3](/blog/2026/database-skills-part-3-production/) covers production-grade database engineering.*
